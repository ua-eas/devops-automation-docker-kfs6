...
ENV KFS_VERSION_DEV=devops-automation-release34-SNAPSHOT
ENV KFS_REPOSITORY_DEV=snapshots

ENV KFS_VERSION_TST=devops-automation-release34-SNAPSHOT
ENV KFS_REPOSITORY_TST=snapshots

ENV KFS_VERSION_STG=devops-automation-release33
