...
ENV KFS_VERSION_DEV=ua-devops-automation-release39-SNAPSHOT
ENV KFS_REPOSITORY_DEV=snapshots

ENV KFS_VERSION_TST=ua-devops-automation-release39-SNAPSHOT
ENV KFS_REPOSITORY_TST=snapshots

ENV KFS_VERSION_STG=ua-devops-automation-release38
